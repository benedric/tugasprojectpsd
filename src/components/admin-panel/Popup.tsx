...
const Popup = ({setOpenPopup, setUpdateTable}:PropsType) => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full h-screen bg-[#00000070] grid place-items-xenter'>
        <div className='bg-white w-[700px] py-8 rounded-lg text-center relative'>
            ...
            <form className='mt-6 w-fit space-y-4 mx-auto' onSubmit={handleSubmit} action="">
                <input
