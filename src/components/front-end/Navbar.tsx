...
const Navbar = ({ setShowCart }: PropsType) => {
  const cartCount = useAppSelector((state) => state.cartReducer?.length || 0); // Pastikan cartReducer valid

  return (
    <div className="pt-4 bg-white top-zero sticky">
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="text-4xl font-bold">LOGO</div>
          <div className="lg:flex hidden w-full max-w-[500px] cursor-pointer">
